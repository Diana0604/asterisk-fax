...
question = raw_input("Write OK if you see nothing. Write anything else otherwise. ")
...
question = raw_input("Write OK if you see red. Write anything else otherwise. ")
...
question = raw_input("Write OK if you see green. Write anything else otherwise. ")
...
question = raw_input("Write OK if you see blue. Write anything else otherwise. ")
